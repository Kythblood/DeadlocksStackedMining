...
if mods["CompressedFluids"] and getSettingValue("kyth-high-pressure-offshore-pump") then
    ...
    if not mods["PressurizedBarrels"] then
        ...
        hp_offshore_pump_entity.fluid = "high-pressure-water"
        hp_offshore_pump_entity.fluid_box.filter = "high-pressure-water"
        ...
        hp_offshore_pump_item.order = "b[fluids]-ab[high-pressure-offshore-pump]"
        hp_offshore_pump_item.place_result = hp_offshore_pump_entity.name

        local hp_offshore_pump_recipe = table.deepcopy(data.raw.recipe["offshore-pump"])
        
        hp_offshore_pump_recipe.name = "kyth-high-pressure-offshore-pump"
        hp_offshore_pump_recipe.result = "kyth-high-pressure-offshore-pump"
        hp_offshore_pump_recipe.ingredients = 
        {
            {"advanced-circuit", 10},
            {"steel-plate", 15},
            {"pump", 2},
    ...
    if mods["FactorioExtended-Plus-Transport"] then
        ...
        local hp_offshore_pump_entity = table.deepcopy(data.raw["offshore-pump"]["offshore-pump-mk2"])


        hp_offshore_pump_entity.name = "kyth-high-pressure-offshore-pump-mk2"
        hp_offshore_pump_entity.icon = "__Kythbloods_Stacked_Mining__/graphics/icons/offshore-pump-mk2.png"
        hp_offshore_pump_entity.icon_size = 64
        hp_offshore_pump_entity.icon_mipmaps = 4
        hp_offshore_pump_entity.icons = nil

        hp_offshore_pump_entity.max_health = 300
        hp_offshore_pump_entity.fluid = "high-pressure-water"
        hp_offshore_pump_entity.fluid_box.filter = "high-pressure-water"
        -- adjust the pumping speed to keep the (uncompressed output/sec the same overall)
        hp_offshore_pump_entity.pumping_speed = hp_offshore_pump_entity.pumping_speed / getSettingValue("fluid-compression-rate")
        ...
        local hp_offshore_pump_item = table.deepcopy(data.raw.item["offshore-pump-mk2"])

        hp_offshore_pump_item.name = "kyth-high-pressure-offshore-pump-mk2"
        hp_offshore_pump_item.icon = "__Kythbloods_Stacked_Mining__/graphics/icons/offshore-pump-mk2.png"
        hp_offshore_pump_item.icon_size = 64
        hp_offshore_pump_item.icon_mipmaps = 4
        hp_offshore_pump_item.icons = nil
        hp_offshore_pump_item.order = "b[fluids]-ab[high-pressure-offshore-pump-mk2]"
        hp_offshore_pump_item.place_result = hp_offshore_pump_entity.name
        hp_offshore_pump_item.next_upgrade = nil

        local hp_offshore_pump_recipe = table.deepcopy(data.raw.recipe["offshore-pump-mk2"])
        
        hp_offshore_pump_recipe.name = "kyth-high-pressure-offshore-pump-mk2"
        hp_offshore_pump_recipe.result = "kyth-high-pressure-offshore-pump-mk2"
        --hp_offshore_pump_recipe.icon = "__Kythbloods_Stacked_Mining__/graphics/icons/offshore-pump-mk2.png"
        --hp_offshore_pump_recipe.icon_size = 64
        --hp_offshore_pump_recipe.icon_mipmaps = 4
        
        if mods["PressurizedBarrels"] and data.raw.item["high-pressure-offshore-pump"] then
            hp_offshore_pump_recipe.ingredients = 
            {
                {"advanced-circuit", 10},
                {"titanium-alloy", 15},
        ...
        elseif not mods["PressurizedBarrels"] then
            hp_offshore_pump_recipe.ingredients = 
            {
                ...
                {"titanium-alloy", 15},
                {"pump-mk2", 2},
                {"kyth-high-pressure-offshore-pump", 1}
            }
        end
